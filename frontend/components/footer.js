                  ...
                  <div className="row" data-container="container">
                      ...
                      >
                        <div className="moto-widget-text-content moto-widget-text-editable">
                          <p className="moto-text_system_14">
                            Археологический кружок создан при лаборатории
                            археологии и этнологии. Функционирует во внеучебное
                            время в течение всего учебного года.
                          </p>
                          <p className="moto-text_system_14">&nbsp;</p>
                          <p className="moto-text_186">
                            <span className="moto-color3_3">
                    ...
                    >
                      ...
                      >
                        <div className="moto-widget-text-content moto-widget-text-editable">
                          <p className="moto-text_system_11">
                            <span className="moto-color5_5">ИНФОРМАЦИЯ</span>
                          </p>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        <div className="moto-widget-text-content moto-widget-text-editable">
                          <ul>
                            <li className="moto-text_205">
                              <Link href={`/`}>
                                <a className="moto-link">Главная</a>
                              </Link>
                            </li>
                            <li className="moto-text_205">
                              <Link href={`/heroes`}>
                                <a className="moto-link">Герои</a>
                              </Link>
                            </li>
                            <li className="moto-text_205">
                              <Link href={`/add-hero`}>
                                <a className="moto-link">Увековечить</a>
                              </Link>
                            </li>
                          </ul>
                        </div>
